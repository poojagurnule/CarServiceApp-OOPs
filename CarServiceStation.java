...
class Main {
    public static void main(String[] args) {
        ...
        CarService serviceStation = new CarService(carTypes, services);
        Bill billGenerator = new Bill(serviceStation);
        ...
        System.out.println("Available Services and their codes:");
